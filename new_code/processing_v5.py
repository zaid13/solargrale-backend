...
#         image_path = os.path.join(output_dir, 'pv_area_map.png')  # Dateiendung auf '.jpeg' geändert
#
...
# def add_page_number(canvas, meta_data,):
...
#         doc = MyDocTemplate(doc_name,project_name=meta_data.project_name, pagesize=A4, rightMargin=inch, leftMargin=inch, topMargin=inch, bottomMargin=inch)
#         elements = []
#
#         # Title page
#         assetspath = f'{Path.cwd()}/assets/'
#         logo_path = assetspath+'logo_v1.png'
...
#
#         map_image_path = os.path.join(output_dir, 'pv_area_map.png')
#         #resized_map_image_path = resize_image(map_image_path, 5 * inch, 5 * inch)
...
#                     # resized_image_path = resize_image(image_path, width, height / aspect_ratio_n)
...
# """
#
# def calculate_glare(_pv_areas, list_of_pv_area_information, list_of_ops, _meta_data, _simulation_parameter,google_api_key, output_dir,excluded_areas = []):
#
